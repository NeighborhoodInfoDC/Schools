/**************************************************************************
 ...
 Previous Program: Enrollment Import.sas 
...
%Super_transpose(  
  data=schools.DCPS_longenroll ,     /** Input data set **/
  out=DCPS_longenroll1,      /** Output data set **/
...
%macro label;
	data DCPS_longenroll2;
				set DCPS_longenroll1;	
				label
...
/*here ends merge of master school file on to enrollment file 7/18/2011 SL*/
 ...
 %macro totals;
	data DCPS_allsch_lngenrl;
	set DCPS_longenroll2;
	%let macro_year = 0102 0203 0304 0405 0506 0607 0708 0809 0910;
		...
		label aud_&i._total = "Total Audited Enrollment 20&j.-&k.";
...
proc sort data=DCPS_allsch_lngenrl;
by UI_ID;
run;

data schools.DCPS_allsch_lngenrl(label="DCPS Audited and Certified Enrollment File");
set DCPS_allsch_lngenrl;
run;

%file_info(data=Schools.DCPS_allsch_lngenrl)

ods html file="D:\DCData\Libraries\schools\data\DCPS Audited and Certified Enrollment File.xls" style=minimal; 
	proc print data= schools.DCPS_allsch_lngenrl label noobs;
