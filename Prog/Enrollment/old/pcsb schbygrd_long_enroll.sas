...
filename dat dde "excel|K:\Metro\PTatian\DCData\Libraries\Schools\Data\Enrollment\PCSB\[pcsb School-by-Grade Enrollment, Audited and Oct.Cert.2001-2009_ZMchanges.xls]Sheet1! r4c1:r1679c22" ;
	data dcd.Pcsb_longenroll; 
...
%macro label;
	...
	%do grd=1 %to 16;
	%let i=%scan(&macro_grade,&grd,' ');	
		data PCSB_longenroll2_&i.;
		set PCSB_longenroll_&i.;	
		label
...
%mend label;
%label;
/*crosswalk including UI_ID, master school name and all GEOG variables*/
...
data PCSB_allsch_lngenrl_1;
	merge 
		/*crosswalk_longenroll (in=a)*/ PCSB_longenroll2_k (in=b) PCSB_longenroll2_PK (in=c)  PCSB_longenroll2_PS (in=d)
		PCSB_longenroll2_1 (in=e) PCSB_longenroll2_2 (in=f) PCSB_longenroll2_3 (in=g) PCSB_longenroll2_4 (in=h) 
		PCSB_longenroll2_5 (in=i) PCSB_longenroll2_6 (in=j) PCSB_longenroll2_7 (in=k) PCSB_longenroll2_8 (in=l) 
		PCSB_longenroll2_9 (in=m) PCSB_longenroll2_10 (in=n) PCSB_longenroll2_11 (in=o)
		PCSB_longenroll2_12 (in=p) PCSB_longenroll2_Adult (in=q);
	by UI_ID;
...
data dcd.PCSB_allsch_lngenrl;
set PCSB_allsch_lngenrl_2;
run;
