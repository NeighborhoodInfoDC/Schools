...
filename dat dde "excel|K:\Metro\PTatian\DCData\Libraries\Schools\Raw\MasterSchoolFile\[Master School File 11_18_09.xls]master_school_with_minmax! r5c4:r346c34" ;
...
/*if master_school_name = "Fletcher Johnson" then UI_ID = "1040300";*Operating before 2003, switched to Fletcher-Johnson Education Complex;*/ 
...
data gen.schnum_name_UIID_crosswalk_0910;
  ...
  *         keep master_school_name UI_ID school_num dcps_flag  pcsb_flag UI_ID2;
            keep master_school_name UI_ID school_number dcps pcsb School_Name_2009_2010;
