/**************************************************************************
 ...
 Description: Translates BOE 0607 data from "long" to "wide"; 
 Modifications:
**************************************************************************/
...
filename dat dde "excel|K:\Metro\PTatian\DCData\Libraries\Schools\Test Scores\UI_ID\[testscore_BOE_0607.xls]sheet1! r2c4:r81c18" ;
	data testscore_BOE_0607; 
...
data crosswalk0607;
	...
	proc sort data = crosswalk0607;
		...
		run;
/*sort testscore data*/
	proc sort data = testscore_BOE_0607;
		by UI_ID;
		run;
/*merge testscore data and crosswalk, label all variables*/
	data dcd.testscore_BOE_0607;
		merge crosswalk0607 testscore_BOE_0607 (in = a); 
		by UI_ID;
		if a; 
		run; 
%macro grade_sep;
...
data dcd.BOE_0607_wide;
	merge crosswalk_0607_2 BOE_0607_3 BOE_0607_4 BOE_0607_5 BOE_0607_6 
			 BOE_0607_7 BOE_0607_8 BOE_0607_10;
	by UI_ID;
	run;
