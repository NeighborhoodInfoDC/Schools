/**************************************************************************
 Program:  read in PCSB 0607.sas
 Library:  Prog\cleaning
 Project:  schools
 Author:   Z. McDade
 Created:  07/02/2010
 UPDATED:  07/19/2010 with year-specific vars for master test score dataset
 Version:  SAS 9.1
 Environment:  Windows with SAS/Connect
 
 Description: Translates 0607 PCSB data from "long" to "wide"; 
 Modifications:
**************************************************************************/
...
filename dat dde "excel|K:\Metro\PTatian\DCData\Libraries\Schools\Test Scores\UI_ID\[testscore_pcsb_0607.xls]sheet1! r2c2:r231c16" ;
	data testscore_pcsb_0607; 
...
data crosswalk0607;
	...
	proc sort data = crosswalk0607;
		...
		run;
/*sort testscore data*/
	proc sort data = testscore_pcsb_0607;
		by UI_ID;
		run;
/*merge testscore data and crosswalk, label all variables*/
	data dcd.testscore_pcsb_0607;
		merge crosswalk0607 testscore_pcsb_0607 (in = a); 
		by UI_ID;
		if a; 
		run; 
%macro grade_sep;
...
data dcd.pcsb_0607_wide;
	merge crosswalk_0607_2 pcsb_0607_3 pcsb_0607_4 pcsb_0607_5 pcsb_0607_6 
			 pcsb_0607_7 pcsb_0607_8 pcsb_0607_10;
	by UI_ID;
	run;
